...
CREATE TABLE `appointment` (
  ...
  CONSTRAINT `appointment_FK` FOREIGN KEY (`c_id`) REFERENCES `card` (`c_id`),
  CONSTRAINT `appointment_FK_1` FOREIGN KEY (`s_id`) REFERENCES `schedule` (`s_id`)
...
CREATE TABLE `card` (
  ...
  KEY `patient_FK` (`u_id`),
  CONSTRAINT `patient_FK` FOREIGN KEY (`u_id`) REFERENCES `user` (`u_id`)
...
CREATE TABLE `department` (
  ...
  CONSTRAINT `department_FK` FOREIGN KEY (`cli_id`) REFERENCES `clinic` (`cli_id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `doctor` (
  ...
  PRIMARY KEY (`doc_id`),
  KEY `doctor_FK` (`d_id`),
  CONSTRAINT `doctor_FK` FOREIGN KEY (`d_id`) REFERENCES `department` (`d_id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `prescription` (
  ...
  CONSTRAINT `prescription_FK` FOREIGN KEY (`ap_id`) REFERENCES `appointment` (`ap_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `schedule` (
  ...
  CONSTRAINT `schedule_FK` FOREIGN KEY (`doc_id`) REFERENCES `doctor` (`doc_id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
